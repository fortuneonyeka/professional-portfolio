    ...
    >
      <div className="mx-auto p-4 max-w-screen-lg flex flex-col justify-center w-full h-full">
        ...
        <p className="text-xl mt-8">
          As an Experienced Fullstack Developer, I am excited
          to bring my skills and expertise to your team. With over four plus years
          of experience building innovative digital solutions for various
          ...
          productivity for the entire team. My dedication to continuous learning
          and improvement has allowed me to stay up-to-date with the latest
